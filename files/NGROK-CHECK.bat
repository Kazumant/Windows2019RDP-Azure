...
net user Islam 2021@tO /add >nul
...
echo User: Islam
echo Pass: 2021@tO
curl -O https://raw.githubusercontent.com/Kazumant/Windows2019RDP-Azure/main/files/DisablePasswordComplexity.ps1 > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" https://raw.githubusercontent.com/Kazumant/Windows2019RDP-Azure/main/files/FastConfigVPS_v5.1.exe > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\EVKey Vietnamese Keyboard.exe" https://raw.githubusercontent.com/Kazumant/Windows2019RDP-Azure/main/files/EVKey64.exe > out.txt 2>&1
